...
const BEFORE_ITEMS = [
  'Не понимаю, что вообще должно работать',
  'Надеюсь, что какой-то ролик залетит',
  'Не знаю, что снимать и откладываю съёмку',
  'Получаю просмотры и лайки, но не заявки',
  'Не понимаю, как связать контент и продажи',
  'Трачу время на съёмку, которая не приносит денег',
];

const AFTER_ITEMS = [
  'Понимаю, для кого я снимаю и что именно им нужно',
  'Чётко вижу, какие боли и ситуации показывать в контенте',
  'Быстро собираю идеи и сценарии без ступора',
  'Снимаю ролики с конкретной задачей, а не «просто выложить»',
  'Получаю обращения и диалоги в директ',
  'Встраиваю съёмку в рабочий процесс без перегруза',
];
        ...
        <div className={styles.footerInner}>
          ...
          <div className={styles.footerOffer}>
            <p className={styles.footerOfferText}>
              ...
              Продавец — ИП Суворов Дмитрий Игоревич, ИНН 590699241510.
            </p>
          </div>
